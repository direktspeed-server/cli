...
var installIfMissing = exports.installIfMissing = function(root, module, range) {
  ...
  return function() {
    try {
      ...
      // make npm optional return runCommand('yarn', ['add', module, '--loglevel', 'error']);
      return runCommand('yarn', ['add', module]);
    }
  };
};

// Run any of the Yeoman generators from the current generator-dssrv
